...
int main()
{
    std::cout << "Работает тестовая версия программы \"Блекджек\" (пока что без шлюх)\n";
    ...
    public:
        ...
        Card topdeck()
        {
            std::cout << "Выдача верхней карты" << std::endl;
